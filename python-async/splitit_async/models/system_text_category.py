...
class SystemTextCategory(object):
    ...
    def __init__(self):  # noqa: E501
        """SystemTextCategory - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SystemTextCategory, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SystemTextCategory):
            return False

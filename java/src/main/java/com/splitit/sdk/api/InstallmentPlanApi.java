...
import com.splitit.sdk.model.RequestPaymentRequest;
import com.splitit.sdk.model.RequestPaymentResponse;
...
public class InstallmentPlanApi {
    ...
    /**
     * Build call for installmentPlanRequestPayment
     * @param request  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call installmentPlanRequestPaymentCall(RequestPaymentRequest request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = request;

        // create path and map variables
        String localVarPath = "/api/InstallmentPlan/RequestPayment";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call installmentPlanRequestPaymentValidateBeforeCall(RequestPaymentRequest request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'request' is set
        if (request == null) {
            throw new ApiException("Missing the required parameter 'request' when calling installmentPlanRequestPayment(Async)");
        }
        

        com.squareup.okhttp.Call call = installmentPlanRequestPaymentCall(request, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public RequestPaymentResponse installmentPlanRequestPayment(RequestPaymentRequest request) throws ApiException {
        ApiResponse<RequestPaymentResponse> resp = installmentPlanRequestPaymentWithHttpInfo(request);
        return resp.getData();
    }
     ...
     * 
     * @param request  (required)
     * @return ApiResponse&lt;RequestPaymentResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RequestPaymentResponse> installmentPlanRequestPaymentWithHttpInfo(RequestPaymentRequest request) throws ApiException {
        if ("installmentPlanRequestPayment" != "loginPost") {
            apiClient.performAutologin(false);
        }

        com.squareup.okhttp.Call call = installmentPlanRequestPaymentValidateBeforeCall(request, null, null);
        Type localVarReturnType = new TypeToken<RequestPaymentResponse>(){}.getType();
        try{
            return apiClient.execute(call, localVarReturnType);
        } catch (ApiException e) {
            if (("installmentPlanRequestPayment" != "loginPost") && (e.getCode() == 704)){
                // Stale session, force-relogin
                apiClient.performAutologin(true);
                // Re-generate the request (to include updated sessionID)
                call = installmentPlanRequestPaymentValidateBeforeCall(request, null, null);
                localVarReturnType = new TypeToken<RequestPaymentResponse>(){}.getType();
                return apiClient.execute(call, localVarReturnType);
            } else {
                throw e;
            }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call installmentPlanRequestPaymentAsync(RequestPaymentRequest request, final ApiCallback<RequestPaymentResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = installmentPlanRequestPaymentValidateBeforeCall(request, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<RequestPaymentResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }

...
class InstallmentPlan {
     ...
     * @param keepNonApprovedPlanLive {String} 
     * @param extendPlanLiveTimeOnPaymentRequest {String} 
     * @param extendPlanLiveTimeOnApprovalRequest {String} 
     ...
     */
    constructor(numberOfInstallments, numberOfProcessedInstallments, keepNonApprovedPlanLive, extendPlanLiveTimeOnPaymentRequest, extendPlanLiveTimeOnApprovalRequest, isFullCaptured, isChargedBack, arePaymentsOnHold, scpFundingPercent, testMode, creationDateTime) { 
        
        InstallmentPlan.initialize(this, numberOfInstallments, numberOfProcessedInstallments, keepNonApprovedPlanLive, extendPlanLiveTimeOnPaymentRequest, extendPlanLiveTimeOnApprovalRequest, isFullCaptured, isChargedBack, arePaymentsOnHold, scpFundingPercent, testMode, creationDateTime);
    }
     ...
     */
    static initialize(obj, numberOfInstallments, numberOfProcessedInstallments, keepNonApprovedPlanLive, extendPlanLiveTimeOnPaymentRequest, extendPlanLiveTimeOnApprovalRequest, isFullCaptured, isChargedBack, arePaymentsOnHold, scpFundingPercent, testMode, creationDateTime) { 
        obj['NumberOfInstallments'] = numberOfInstallments;
        obj['NumberOfProcessedInstallments'] = numberOfProcessedInstallments;
        obj['KeepNonApprovedPlanLive'] = keepNonApprovedPlanLive;
        obj['ExtendPlanLiveTimeOnPaymentRequest'] = extendPlanLiveTimeOnPaymentRequest;
        obj['ExtendPlanLiveTimeOnApprovalRequest'] = extendPlanLiveTimeOnApprovalRequest;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Terminal')) {
                obj['Terminal'] = TerminalRef.constructFromObject(data['Terminal']);
            }
            ...
            if (data.hasOwnProperty('KeepNonApprovedPlanLive')) {
                obj['KeepNonApprovedPlanLive'] = ApiClient.convertToType(data['KeepNonApprovedPlanLive'], 'String');
            }
            if (data.hasOwnProperty('ExtendPlanLiveTimeOnPaymentRequest')) {
                obj['ExtendPlanLiveTimeOnPaymentRequest'] = ApiClient.convertToType(data['ExtendPlanLiveTimeOnPaymentRequest'], 'String');
            }
            if (data.hasOwnProperty('ExtendPlanLiveTimeOnApprovalRequest')) {
                obj['ExtendPlanLiveTimeOnApprovalRequest'] = ApiClient.convertToType(data['ExtendPlanLiveTimeOnApprovalRequest'], 'String');
            }
...
/**
 * @member {module:model/TerminalRef} Terminal
 */
InstallmentPlan.prototype['Terminal'] = undefined;
...
/**
 * @member {String} KeepNonApprovedPlanLive
 */
InstallmentPlan.prototype['KeepNonApprovedPlanLive'] = undefined;

/**
 * @member {String} ExtendPlanLiveTimeOnPaymentRequest
 */
InstallmentPlan.prototype['ExtendPlanLiveTimeOnPaymentRequest'] = undefined;

/**
 * @member {String} ExtendPlanLiveTimeOnApprovalRequest
 */
InstallmentPlan.prototype['ExtendPlanLiveTimeOnApprovalRequest'] = undefined;

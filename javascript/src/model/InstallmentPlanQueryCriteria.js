...
class InstallmentPlanQueryCriteria {
     ...
     * @param eula {Boolean} 
     */
    constructor(merchantId, currencyId, installmentPlanId, installmentPlanAmount, pisMemberId, eula) { 
        
        InstallmentPlanQueryCriteria.initialize(this, merchantId, currencyId, installmentPlanId, installmentPlanAmount, pisMemberId, eula);
    }
     ...
     */
    static initialize(obj, merchantId, currencyId, installmentPlanId, installmentPlanAmount, pisMemberId, eula) { 
 ...
 */
InstallmentPlanQueryCriteria.prototype['TerminalId'] = undefined;

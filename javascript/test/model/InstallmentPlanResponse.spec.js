...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SplititWebApiPublic.InstallmentPlanResponse();
  });
  ...
  describe('InstallmentPlanResponse', function() {
    it('should create an instance of InstallmentPlanResponse', function() {
      // uncomment below and update the code to test InstallmentPlanResponse
      //var instane = new SplititWebApiPublic.InstallmentPlanResponse();
      //expect(instance).to.be.a(SplititWebApiPublic.InstallmentPlanResponse);
    });

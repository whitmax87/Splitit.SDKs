...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SplititWebApiPublic.VerifyPaymentRequest();
  });
  ...
  describe('VerifyPaymentRequest', function() {
    it('should create an instance of VerifyPaymentRequest', function() {
      // uncomment below and update the code to test VerifyPaymentRequest
      //var instane = new SplititWebApiPublic.VerifyPaymentRequest();
      //expect(instance).to.be.a(SplititWebApiPublic.VerifyPaymentRequest);
    });

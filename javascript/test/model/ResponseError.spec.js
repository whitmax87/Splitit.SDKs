...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SplititWebApiPublic.ResponseError();
  });
  ...
  describe('ResponseError', function() {
    it('should create an instance of ResponseError', function() {
      ...
      //var instane = new SplititWebApiPublic.ResponseError();
      //expect(instance).to.be.a(SplititWebApiPublic.ResponseError);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SplititWebApiPublic.LoginResponse();
  });
  ...
  describe('LoginResponse', function() {
    it('should create an instance of LoginResponse', function() {
      ...
      //var instane = new SplititWebApiPublic.LoginResponse();
      //expect(instance).to.be.a(SplititWebApiPublic.LoginResponse);
    });

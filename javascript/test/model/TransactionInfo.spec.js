...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SplititWebApiPublic.TransactionInfo();
  });
  ...
  describe('TransactionInfo', function() {
    it('should create an instance of TransactionInfo', function() {
      ...
      //var instane = new SplititWebApiPublic.TransactionInfo();
      //expect(instance).to.be.a(SplititWebApiPublic.TransactionInfo);
    });

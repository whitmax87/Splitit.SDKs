...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SplititWebApiPublic.CreateInstallmentPlanRequest();
  });
  ...
  describe('CreateInstallmentPlanRequest', function() {
    it('should create an instance of CreateInstallmentPlanRequest', function() {
      // uncomment below and update the code to test CreateInstallmentPlanRequest
      //var instane = new SplititWebApiPublic.CreateInstallmentPlanRequest();
      //expect(instance).to.be.a(SplititWebApiPublic.CreateInstallmentPlanRequest);
    });

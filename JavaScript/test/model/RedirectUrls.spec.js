...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SplititWebApiPublic.RedirectUrls();
  });
  ...
  describe('RedirectUrls', function() {
    it('should create an instance of RedirectUrls', function() {
      // uncomment below and update the code to test RedirectUrls
      //var instane = new SplititWebApiPublic.RedirectUrls();
      //expect(instance).to.be.a(SplititWebApiPublic.RedirectUrls);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SplititWebApiPublic.InitiateInstallmentPlanRequest();
  });
  ...
  describe('InitiateInstallmentPlanRequest', function() {
    it('should create an instance of InitiateInstallmentPlanRequest', function() {
      // uncomment below and update the code to test InitiateInstallmentPlanRequest
      //var instane = new SplititWebApiPublic.InitiateInstallmentPlanRequest();
      //expect(instance).to.be.a(SplititWebApiPublic.InitiateInstallmentPlanRequest);
    });
    ...
    it('should have the property paymentWizardData (base name: "PaymentWizardData")', function() {
      // uncomment below and update the code to test the property paymentWizardData
      //var instane = new SplititWebApiPublic.InitiateInstallmentPlanRequest();
      //expect(instance).to.be();
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SplititWebApiPublic.AmountDetails2();
  });
  ...
  describe('AmountDetails2', function() {
    it('should create an instance of AmountDetails2', function() {
      // uncomment below and update the code to test AmountDetails2
      //var instane = new SplititWebApiPublic.AmountDetails2();
      //expect(instance).to.be.a(SplititWebApiPublic.AmountDetails2);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SplititWebApiPublic.StartInstallmentsRequest();
  });
  ...
  describe('StartInstallmentsRequest', function() {
    it('should create an instance of StartInstallmentsRequest', function() {
      // uncomment below and update the code to test StartInstallmentsRequest
      //var instane = new SplititWebApiPublic.StartInstallmentsRequest();
      //expect(instance).to.be.a(SplititWebApiPublic.StartInstallmentsRequest);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SplititWebApiPublic.ResponseStatus();
  });
  ...
  describe('ResponseStatus', function() {
    it('should create an instance of ResponseStatus', function() {
      ...
      //var instane = new SplititWebApiPublic.ResponseStatus();
      //expect(instance).to.be.a(SplititWebApiPublic.ResponseStatus);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SplititWebApiPublic.CreateInstallmentsPlanResponse();
  });
  ...
  describe('CreateInstallmentsPlanResponse', function() {
    it('should create an instance of CreateInstallmentsPlanResponse', function() {
      // uncomment below and update the code to test CreateInstallmentsPlanResponse
      //var instane = new SplititWebApiPublic.CreateInstallmentsPlanResponse();
      //expect(instance).to.be.a(SplititWebApiPublic.CreateInstallmentsPlanResponse);
    });

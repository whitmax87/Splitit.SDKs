...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SplititWebApiPublic.ApproveInstallmentPlanRequest();
  });
  ...
  describe('ApproveInstallmentPlanRequest', function() {
    it('should create an instance of ApproveInstallmentPlanRequest', function() {
      // uncomment below and update the code to test ApproveInstallmentPlanRequest
      //var instane = new SplititWebApiPublic.ApproveInstallmentPlanRequest();
      //expect(instance).to.be.a(SplititWebApiPublic.ApproveInstallmentPlanRequest);
    });

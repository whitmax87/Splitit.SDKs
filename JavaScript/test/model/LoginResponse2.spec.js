...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SplititWebApiPublic.LoginResponse2();
  });
  ...
  describe('LoginResponse2', function() {
    it('should create an instance of LoginResponse2', function() {
      // uncomment below and update the code to test LoginResponse2
      //var instane = new SplititWebApiPublic.LoginResponse2();
      //expect(instance).to.be.a(SplititWebApiPublic.LoginResponse2);
    });

...
class InstallmentPlan(object):
    ...
    attribute_map = {
        ...
        'extend_plan_live_time_on_payment_request': 'ExtendPlanLiveTimeOnPaymentRequest',
        'extend_plan_live_time_on_approval_request': 'ExtendPlanLiveTimeOnApprovalRequest',
    ...
    def __init__(self, installment_plan_number=None, installment_plan_status=None, amount=None, outstanding_amount=None, number_of_installments=None, number_of_processed_installments=None, original_amount=None, refund_amount=None, consumer=None, active_card=None, fraud_check=None, terminal=None, merchant=None, ref_order_number=None, purchase_method=None, strategy=None, delay_resolution=None, keep_non_approved_plan_live=None, extend_plan_live_time_on_payment_request=None, extend_plan_live_time_on_approval_request=None, extended_params=None, is_full_captured=None, is_charged_back=None, are_payments_on_hold=None, scp_funding_percent=None, test_mode=None, creation_date_time=None, installments=None, secure_authorizations=None):  # noqa: E501
        ...
        self._extend_plan_live_time_on_payment_request = None
        self._extend_plan_live_time_on_approval_request = None
        ...
        self.keep_non_approved_plan_live = keep_non_approved_plan_live
        self.extend_plan_live_time_on_payment_request = extend_plan_live_time_on_payment_request
        self.extend_plan_live_time_on_approval_request = extend_plan_live_time_on_approval_request
    ...
    @property
    def terminal(self):
        """Gets the terminal of this InstallmentPlan.  # noqa: E501


        :return: The terminal of this InstallmentPlan.  # noqa: E501
        :rtype: TerminalRef
        """
    ...
    def terminal(self, terminal):
        """Sets the terminal of this InstallmentPlan.


        :param terminal: The terminal of this InstallmentPlan.  # noqa: E501
        :type: TerminalRef
        """
    ...
    def keep_non_approved_plan_live(self):
        """Gets the keep_non_approved_plan_live of this InstallmentPlan.  # noqa: E501


        :return: The keep_non_approved_plan_live of this InstallmentPlan.  # noqa: E501
        :rtype: str
        """
    ...
    def keep_non_approved_plan_live(self, keep_non_approved_plan_live):
        """Sets the keep_non_approved_plan_live of this InstallmentPlan.


        :param keep_non_approved_plan_live: The keep_non_approved_plan_live of this InstallmentPlan.  # noqa: E501
        :type: str
        """
    ...
    @property
    def extend_plan_live_time_on_payment_request(self):
        """Gets the extend_plan_live_time_on_payment_request of this InstallmentPlan.  # noqa: E501


        :return: The extend_plan_live_time_on_payment_request of this InstallmentPlan.  # noqa: E501
        :rtype: str
        """
        return self._extend_plan_live_time_on_payment_request

    @extend_plan_live_time_on_payment_request.setter
    def extend_plan_live_time_on_payment_request(self, extend_plan_live_time_on_payment_request):
        """Sets the extend_plan_live_time_on_payment_request of this InstallmentPlan.


        :param extend_plan_live_time_on_payment_request: The extend_plan_live_time_on_payment_request of this InstallmentPlan.  # noqa: E501
        :type: str
        """
        if extend_plan_live_time_on_payment_request is None:
            raise ValueError("Invalid value for `extend_plan_live_time_on_payment_request`, must not be `None`")  # noqa: E501

        self._extend_plan_live_time_on_payment_request = extend_plan_live_time_on_payment_request

    @property
    def extend_plan_live_time_on_approval_request(self):
        """Gets the extend_plan_live_time_on_approval_request of this InstallmentPlan.  # noqa: E501


        :return: The extend_plan_live_time_on_approval_request of this InstallmentPlan.  # noqa: E501
        :rtype: str
        """
        return self._extend_plan_live_time_on_approval_request

    @extend_plan_live_time_on_approval_request.setter
    def extend_plan_live_time_on_approval_request(self, extend_plan_live_time_on_approval_request):
        """Sets the extend_plan_live_time_on_approval_request of this InstallmentPlan.


        :param extend_plan_live_time_on_approval_request: The extend_plan_live_time_on_approval_request of this InstallmentPlan.  # noqa: E501
        :type: str
        """
        if extend_plan_live_time_on_approval_request is None:
            raise ValueError("Invalid value for `extend_plan_live_time_on_approval_request`, must not be `None`")  # noqa: E501

        self._extend_plan_live_time_on_approval_request = extend_plan_live_time_on_approval_request

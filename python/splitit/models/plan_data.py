...
class PlanData(object):
    ...
    def __init__(self, number_of_installments=None, amount=None, first_installment_amount=None, ref_order_number=None, test_mode=None, purchase_method=None, strategy=None, extended_params=None, first_charge_date=None, auto_capture=None, is_funded=None, attempt3_d_secure=None):  # noqa: E501

...
namespace Splitit.SDK.Client.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "1.5.-56";
        ...
        {
            UserAgent = "Swagger-Codegen/1.5.-56/csharp";
            BasePath = basePath ?? "https://webapi.production.splitit.com";
            DefaultHeader = new ConcurrentDictionary<string, string>();
            DefaultHeader["Splitit-SDK"] = "CSharp-NetCore-1.5.-56";
            ApiKey = null;
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    SDK Package Version: 1.5.-56\n";

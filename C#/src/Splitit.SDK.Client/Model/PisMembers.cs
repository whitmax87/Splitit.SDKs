...
namespace Splitit.SDK.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PisMembers :  IEquatable<PisMembers>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PisMembers" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PisMembers() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PisMembers" /> class.
        /// </summary>
        ...
        /// <param name="isWelcomeMailSent">isWelcomeMailSent (required).</param>
        /// <param name="consumerFullName">consumerFullName.</param>
        /// <param name="cards">cards.</param>
        /// <param name="pisMemberPasswordHistories">pisMemberPasswordHistories.</param>
        /// <param name="password">password.</param>
        public PisMembers(long? id = default(long?), string culture = default(string), string userFullName = default(string), string phoneNumber = default(string), Roles role = default(Roles), string userName = default(string), string uniqueId = default(string), int? loginAttempt = default(int?), int? maxInvalidLoginAttempts = default(int?), UserStatus status = default(UserStatus), bool? isLocked = default(bool?), string email = default(string), string cultureName = default(string), long? roleId = default(long?), string loginUserName = default(string), DateTime? lastTimeLogin = default(DateTime?), bool? isDataPrivateRestricted = default(bool?), bool? isWelcomeMailSent = default(bool?), string consumerFullName = default(string), List<Cards> cards = default(List<Cards>), List<PisMemberPasswordHistories> pisMemberPasswordHistories = default(List<PisMemberPasswordHistories>), IUserPasswordHistory password = default(IUserPasswordHistory))
        {
            this.Id = id;
        ...
        /// <summary>
        /// Gets or Sets IsWelcomeMailSent
        /// </summary>
        [DataMember(Name="IsWelcomeMailSent", EmitDefaultValue=false)]
        ...
        /// <summary>
        /// Gets or Sets PisMemberPasswordHistories
        /// </summary>
        [DataMember(Name="PisMemberPasswordHistories", EmitDefaultValue=false)]
        public List<PisMemberPasswordHistories> PisMemberPasswordHistories { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IsWelcomeMailSent: ").Append(IsWelcomeMailSent).Append("\n");
            sb.Append("  ConsumerFullName: ").Append(ConsumerFullName).Append("\n");
            sb.Append("  Cards: ").Append(Cards).Append("\n");
            sb.Append("  PisMemberPasswordHistories: ").Append(PisMemberPasswordHistories).Append("\n");
        ...
        {
            return this.Equals(input as PisMembers);
        }

        /// <summary>
        /// Returns true if PisMembers instances are equal
        /// </summary>
        /// <param name="input">Instance of PisMembers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PisMembers input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.IsWelcomeMailSent == input.IsWelcomeMailSent ||
                    (this.IsWelcomeMailSent != null &&
                    this.IsWelcomeMailSent.Equals(input.IsWelcomeMailSent))
                ) && 
                (
                ...
                (
                    this.PisMemberPasswordHistories == input.PisMemberPasswordHistories ||
                    this.PisMemberPasswordHistories != null &&
                    this.PisMemberPasswordHistories.SequenceEqual(input.PisMemberPasswordHistories)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsWelcomeMailSent != null)
                    hashCode = hashCode * 59 + this.IsWelcomeMailSent.GetHashCode();
                ...
                if (this.PisMemberPasswordHistories != null)
                    hashCode = hashCode * 59 + this.PisMemberPasswordHistories.GetHashCode();

...
namespace Splitit.SDK.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiUsers :  IEquatable<ApiUsers>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiUsers" /> class.
        /// </summary>
        ...
        /// <param name="apiUserPasswordHistories">apiUserPasswordHistories.</param>
        /// <param name="merchantId">merchantId (required).</param>
        /// <param name="merchantName">merchantName.</param>
        /// <param name="password">password.</param>
        public ApiUsers(long? id = default(long?), string culture = default(string), string userFullName = default(string), string phoneNumber = default(string), Roles role = default(Roles), string userName = default(string), string uniqueId = default(string), int? loginAttempt = default(int?), int? maxInvalidLoginAttempts = default(int?), UserStatus status = default(UserStatus), bool? isLocked = default(bool?), string email = default(string), string cultureName = default(string), long? roleId = default(long?), string loginUserName = default(string), string crmId = default(string), Merchants merchant = default(Merchants), List<ApiUserPasswordHistories> apiUserPasswordHistories = default(List<ApiUserPasswordHistories>), long? merchantId = default(long?), string merchantName = default(string), IUserPasswordHistory password = default(IUserPasswordHistory))
        {
            this.Id = id;
        ...
        /// <summary>
        /// Gets or Sets ApiUserPasswordHistories
        /// </summary>
        [DataMember(Name="ApiUserPasswordHistories", EmitDefaultValue=false)]
        public List<ApiUserPasswordHistories> ApiUserPasswordHistories { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ApiUserPasswordHistories: ").Append(ApiUserPasswordHistories).Append("\n");
        ...
        {
            return this.Equals(input as ApiUsers);
        }

        /// <summary>
        /// Returns true if ApiUsers instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiUsers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiUsers input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ApiUserPasswordHistories == input.ApiUserPasswordHistories ||
                    this.ApiUserPasswordHistories != null &&
                    this.ApiUserPasswordHistories.SequenceEqual(input.ApiUserPasswordHistories)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ApiUserPasswordHistories != null)
                    hashCode = hashCode * 59 + this.ApiUserPasswordHistories.GetHashCode();

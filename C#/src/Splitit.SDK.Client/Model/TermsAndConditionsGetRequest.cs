...
namespace Splitit.SDK.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TermsAndConditionsGetRequest :  IEquatable<TermsAndConditionsGetRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TermsAndConditionsGetRequest" /> class.
        /// </summary>
        /// <param name="installmentPlanNumber">installmentPlanNumber.</param>
        public TermsAndConditionsGetRequest(string installmentPlanNumber = default(string))
        {
        ...
        {
            return this.Equals(input as TermsAndConditionsGetRequest);
        }

        /// <summary>
        /// Returns true if TermsAndConditionsGetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TermsAndConditionsGetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TermsAndConditionsGetRequest input)
        {
            if (input == null)
                return false;

...
namespace Splitit.SDK.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PisUsers :  IEquatable<PisUsers>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PisUsers" /> class.
        /// </summary>
        ...
        /// <param name="pisUserBusinessUnits">pisUserBusinessUnits.</param>
        /// <param name="pisUserPasswordHistories">pisUserPasswordHistories.</param>
        /// <param name="userJobSubscriptions">userJobSubscriptions.</param>
        /// <param name="password">password.</param>
        public PisUsers(long? id = default(long?), string culture = default(string), string userFullName = default(string), string phoneNumber = default(string), Roles role = default(Roles), string userName = default(string), string uniqueId = default(string), int? loginAttempt = default(int?), int? maxInvalidLoginAttempts = default(int?), UserStatus status = default(UserStatus), bool? isLocked = default(bool?), string email = default(string), string cultureName = default(string), long? roleId = default(long?), string loginUserName = default(string), DateTime? lastTimeLogin = default(DateTime?), bool? isDataPrivateRestricted = default(bool?), string firstName = default(string), string lastName = default(string), string jobTitle = default(string), string faxNumber = default(string), string mobileNumber = default(string), string workPhoneNumber = default(string), string notes = default(string), UserPermissionLevel type = default(UserPermissionLevel), string crmId = default(string), List<Agents> agents = default(List<Agents>), List<PisUserBusinessUnits> pisUserBusinessUnits = default(List<PisUserBusinessUnits>), List<PisUserPasswordHistories> pisUserPasswordHistories = default(List<PisUserPasswordHistories>), List<UserJobSubscriptions> userJobSubscriptions = default(List<UserJobSubscriptions>), IUserPasswordHistory password = default(IUserPasswordHistory))
        {
            this.Id = id;
        ...
        /// <summary>
        /// Gets or Sets PisUserBusinessUnits
        /// </summary>
        [DataMember(Name="PisUserBusinessUnits", EmitDefaultValue=false)]
        public List<PisUserBusinessUnits> PisUserBusinessUnits { get; set; }

        /// <summary>
        /// Gets or Sets PisUserPasswordHistories
        /// </summary>
        [DataMember(Name="PisUserPasswordHistories", EmitDefaultValue=false)]
        public List<PisUserPasswordHistories> PisUserPasswordHistories { get; set; }
        ...
        public IUserPasswordHistory Password { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PisUserBusinessUnits: ").Append(PisUserBusinessUnits).Append("\n");
            sb.Append("  PisUserPasswordHistories: ").Append(PisUserPasswordHistories).Append("\n");
        ...
        {
            return this.Equals(input as PisUsers);
        }

        /// <summary>
        /// Returns true if PisUsers instances are equal
        /// </summary>
        /// <param name="input">Instance of PisUsers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PisUsers input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PisUserBusinessUnits == input.PisUserBusinessUnits ||
                    this.PisUserBusinessUnits != null &&
                    this.PisUserBusinessUnits.SequenceEqual(input.PisUserBusinessUnits)
                ) && 
                (
                    this.PisUserPasswordHistories == input.PisUserPasswordHistories ||
                    this.PisUserPasswordHistories != null &&
                    this.PisUserPasswordHistories.SequenceEqual(input.PisUserPasswordHistories)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PisUserBusinessUnits != null)
                    hashCode = hashCode * 59 + this.PisUserBusinessUnits.GetHashCode();
                if (this.PisUserPasswordHistories != null)
                    hashCode = hashCode * 59 + this.PisUserPasswordHistories.GetHashCode();

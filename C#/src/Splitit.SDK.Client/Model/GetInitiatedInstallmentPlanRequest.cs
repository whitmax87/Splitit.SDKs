...
namespace Splitit.SDK.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetInitiatedInstallmentPlanRequest :  IEquatable<GetInitiatedInstallmentPlanRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetInitiatedInstallmentPlanRequest" /> class.
        /// </summary>
        /// <param name="installmentPlanNumber">installmentPlanNumber.</param>
        public GetInitiatedInstallmentPlanRequest(string installmentPlanNumber = default(string))
        {
        ...
        {
            return this.Equals(input as GetInitiatedInstallmentPlanRequest);
        }

        /// <summary>
        /// Returns true if GetInitiatedInstallmentPlanRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetInitiatedInstallmentPlanRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetInitiatedInstallmentPlanRequest input)
        {
            if (input == null)
                return false;

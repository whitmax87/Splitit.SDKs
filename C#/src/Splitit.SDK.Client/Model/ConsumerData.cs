...
namespace Splitit.SDK.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConsumerData :  IEquatable<ConsumerData>
    {
        /// <summary>
        ...
        public ConsumerData(string id = default(string), string uniqueId = default(string), string userName = default(string), string fullName = default(string), string email = default(string), string phoneNumber = default(string), string cultureName = default(string), string roleName = default(string), bool? isLocked = default(bool?), bool? isDataRestricted = default(bool?))
        {

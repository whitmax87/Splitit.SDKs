...
namespace Splitit.SDK.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApplicativeUser :  IEquatable<ApplicativeUser>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicativeUser" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ApplicativeUser() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicativeUser" /> class.
        /// </summary>
        ...
        public ApplicativeUser(long? id = default(long?), string culture = default(string), string userFullName = default(string), string phoneNumber = default(string), Roles role = default(Roles), string userName = default(string), string uniqueId = default(string), int? loginAttempt = default(int?), int? maxInvalidLoginAttempts = default(int?), UserStatus status = default(UserStatus), bool? isLocked = default(bool?), string email = default(string), string cultureName = default(string), long? roleId = default(long?), string loginUserName = default(string), DateTime? lastTimeLogin = default(DateTime?), bool? isDataPrivateRestricted = default(bool?))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as ApplicativeUser);
        }

        /// <summary>
        /// Returns true if ApplicativeUser instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicativeUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicativeUser input)
        {
            if (input == null)
                return false;

...
namespace Splitit.SDK.Client.Model
{
    ...
    public partial class LoginRequest :  IEquatable<LoginRequest>, IValidatableObject
    {
        ...
        public LoginRequest(string userName = default(string), string password = default(string), RequestHeader requestHeader = default(RequestHeader), TouchPoint touchPoint = default(TouchPoint))
        {

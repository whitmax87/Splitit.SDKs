...
namespace Splitit.SDK.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateInstallmentPlanRequest :  IEquatable<UpdateInstallmentPlanRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateInstallmentPlanRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UpdateInstallmentPlanRequest);
        }

        /// <summary>
        /// Returns true if UpdateInstallmentPlanRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateInstallmentPlanRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateInstallmentPlanRequest input)
        {
            if (input == null)
                return false;

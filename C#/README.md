# Splitit.SDK.Client - the C# library for the splitit-web-api-public-sdk
...
```
Install-Package Splitit.SDK.Client.Portable -Version 1.3.12
```
or visit the NuGet [Project Site](https://www.nuget.org/packages/Splitit.SDK.Client.Portable) for more information.

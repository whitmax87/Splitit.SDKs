...
${nuget_cmd} install src/Splitit.SDK.Client/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Splitit.SDK.Client.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Splitit.SDK.Client.dll \
-recurse:'src/Splitit.SDK.Client/*.cs' \
-doc:bin/Splitit.SDK.Client.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Splitit.SDK.Client.dll was created successfully"
fi

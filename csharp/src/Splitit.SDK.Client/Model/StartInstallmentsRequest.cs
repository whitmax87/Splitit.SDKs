...
namespace Splitit.SDK.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StartInstallmentsRequest :  IEquatable<StartInstallmentsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StartInstallmentsRequest" /> class.
        /// </summary>
        /// <param name="installmentPlanNumber">installmentPlanNumber.</param>
        /// <param name="requestHeader">requestHeader.</param>
        public StartInstallmentsRequest(string installmentPlanNumber = default(string), RequestHeader requestHeader = default(RequestHeader))
        {
        ...
        {
            return this.Equals(input as StartInstallmentsRequest);
        }

        /// <summary>
        /// Returns true if StartInstallmentsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of StartInstallmentsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StartInstallmentsRequest input)
        {
            if (input == null)
                return false;

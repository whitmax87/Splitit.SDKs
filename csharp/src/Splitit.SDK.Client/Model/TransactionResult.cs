...
namespace Splitit.SDK.Client.Model
{
    ...
    public partial class TransactionResult :  IEquatable<TransactionResult>, IValidatableObject
    {
        ...
        public TransactionResult(string gatewayTransactionId = default(string), string gatewayResultCode = default(string), string gatewayResultMessage = default(string), ReferenceEntityBase operationType = default(ReferenceEntityBase), bool? gatewayResult = default(bool?), DateTime? gatewayTransactionDate = default(DateTime?))
        {

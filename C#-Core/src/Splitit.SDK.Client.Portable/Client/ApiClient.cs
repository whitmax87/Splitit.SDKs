...
namespace Splitit.SDK.Client.Portable.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = Splitit.SDK.Client.Portable.Client.Configuration.Default;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://webapi.production.splitit.com).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? Splitit.SDK.Client.Portable.Client.Configuration.Default;
        ...
        public ApiClient(String basePath = "https://webapi.production.splitit.com")
        {
		...
		public void InjectAuthIfNotExists(string apiKey, string sessionId, object request)
        {
            ...
            {
                var prop = request.GetType().GetProperties(System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance)
                    .Where(p => p.PropertyType == typeof(Model.RequestHeader))
                    .FirstOrDefault();

                if (prop != null)
                {
                    var headerVal = prop.GetValue(request);
                    if (headerVal == null)
                    {
                        prop.SetValue(request, new Model.RequestHeader()
                        {

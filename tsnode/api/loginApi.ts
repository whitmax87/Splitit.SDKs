...
export class LoginApi {
     ...
     * @param password 
     */
    public async loginGet (userName?: string, password?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: LoginResponse;  }> {

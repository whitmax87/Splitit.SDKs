...
import { FlexFieldsDataResponse } from '../model/flexFieldsDataResponse';
...
export class TouchPointsApi {
     ...
     * 
     * @param apiKey 
     * @param requestedNumberOfInstallments 
     */
    public async touchPointsFlexFieldsData (apiKey?: string, requestedNumberOfInstallments?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FlexFieldsDataResponse;  }> {
        const localVarPath = this.basePath + '/api/TouchPoints/SetupData/FlexFieldsData';
        ...
        if (requestedNumberOfInstallments !== undefined) {
            localVarQueryParameters['requestedNumberOfInstallments'] = ObjectSerializer.serialize(requestedNumberOfInstallments, "string");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: FlexFieldsDataResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "FlexFieldsDataResponse");

...
export function InstallmentPlanFromJSONTyped(json: any, ignoreDiscriminator: boolean): InstallmentPlan {
    ...
    return {
        ...
        'extendPlanLiveTimeOnPaymentRequest': json['ExtendPlanLiveTimeOnPaymentRequest'],
        'extendPlanLiveTimeOnApprovalRequest': json['ExtendPlanLiveTimeOnApprovalRequest'],
...
export function InstallmentPlanToJSON(value?: InstallmentPlan | null): any {
    ...
    return {
        ...
        'ExtendPlanLiveTimeOnPaymentRequest': value.extendPlanLiveTimeOnPaymentRequest,
        'ExtendPlanLiveTimeOnApprovalRequest': value.extendPlanLiveTimeOnApprovalRequest,

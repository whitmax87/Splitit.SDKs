...
import {
    ...
    ProcessorsAllOf,
    ProcessorsAllOfFromJSON,
    ProcessorsAllOfFromJSONTyped,
    ProcessorsAllOfToJSON,
    ReAuthorizations,
...
export function ProcessorsFromJSON(json: any): Processors {
    return ProcessorsFromJSONTyped(json, false);
}

export function ProcessorsFromJSONTyped(json: any, ignoreDiscriminator: boolean): Processors {
...
export function ProcessorsToJSON(value?: Processors | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {

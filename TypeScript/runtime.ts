...
export const BASE_PATH = "https://webapi.splitit.com".replace(/\/+$/, "");
...
export class BaseAPI {
    ...
    private createFetchParams(context: RequestOpts) {
		...
		if (this._configuration) {
            if (!context.body.RequestHeader) {
                context.body.RequestHeader = {};
            }

            if (this._configuration.apiKey && !context.body.RequestHeader.ApiKey) {
                context.body.RequestHeader.ApiKey = this._configuration.apiKey;
            }

            if (this._configuration.accessToken && !context.body.RequestHeader.SessionId) {
                context.body.RequestHeader.SessionId = this._configuration.accessToken;
            }
        }

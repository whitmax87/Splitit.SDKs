 ...
 * no description
 */
var CreateInstallmentPlanApi = /** @class */ (function (_super) {
    __extends(CreateInstallmentPlanApi, _super);
    function CreateInstallmentPlanApi() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
     */
    CreateInstallmentPlanApi.prototype.createInstallmentPlanGetRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return models_1.CreateInstallmentPlanLegacyResponseFromJSON(jsonValue); })];
                }
            });
        });
    };
    /**
     */
    CreateInstallmentPlanApi.prototype.createInstallmentPlanGet = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.createInstallmentPlanGetRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
    ...
    return CreateInstallmentPlanApi;
}(runtime.BaseAPI));
exports.CreateInstallmentPlanApi = CreateInstallmentPlanApi;

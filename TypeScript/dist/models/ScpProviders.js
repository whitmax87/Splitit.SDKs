...
var _1 = require("./");
function ScpProvidersFromJSON(json) {
    return ScpProvidersFromJSONTyped(json, false);
}
exports.ScpProvidersFromJSON = ScpProvidersFromJSON;
function ScpProvidersFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ScpProvidersFromJSONTyped = ScpProvidersFromJSONTyped;
function ScpProvidersToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ScpProvidersToJSON = ScpProvidersToJSON;

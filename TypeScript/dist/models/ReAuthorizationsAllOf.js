...
var _1 = require("./");
function ReAuthorizationsAllOfFromJSON(json) {
    return ReAuthorizationsAllOfFromJSONTyped(json, false);
}
exports.ReAuthorizationsAllOfFromJSON = ReAuthorizationsAllOfFromJSON;
function ReAuthorizationsAllOfFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ReAuthorizationsAllOfFromJSONTyped = ReAuthorizationsAllOfFromJSONTyped;
function ReAuthorizationsAllOfToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ReAuthorizationsAllOfToJSON = ReAuthorizationsAllOfToJSON;

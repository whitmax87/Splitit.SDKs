...
var _1 = require("./");
function TokensFromJSON(json) {
    return TokensFromJSONTyped(json, false);
}
exports.TokensFromJSON = TokensFromJSON;
function TokensFromJSONTyped(json, ignoreDiscriminator) {
...
exports.TokensFromJSONTyped = TokensFromJSONTyped;
function TokensToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {

...
var _1 = require("./");
function InstallmentPlansFromJSON(json) {
    return InstallmentPlansFromJSONTyped(json, false);
}
exports.InstallmentPlansFromJSON = InstallmentPlansFromJSON;
function InstallmentPlansFromJSONTyped(json, ignoreDiscriminator) {
...
exports.InstallmentPlansFromJSONTyped = InstallmentPlansFromJSONTyped;
function InstallmentPlansToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.InstallmentPlansToJSON = InstallmentPlansToJSON;

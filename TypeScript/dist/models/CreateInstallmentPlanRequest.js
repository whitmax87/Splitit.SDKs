...
var _1 = require("./");
function CreateInstallmentPlanRequestFromJSON(json) {
    return CreateInstallmentPlanRequestFromJSONTyped(json, false);
}
exports.CreateInstallmentPlanRequestFromJSON = CreateInstallmentPlanRequestFromJSON;
function CreateInstallmentPlanRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.CreateInstallmentPlanRequestFromJSONTyped = CreateInstallmentPlanRequestFromJSONTyped;
function CreateInstallmentPlanRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.CreateInstallmentPlanRequestToJSON = CreateInstallmentPlanRequestToJSON;

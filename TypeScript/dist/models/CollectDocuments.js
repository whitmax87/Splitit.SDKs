...
var _1 = require("./");
function CollectDocumentsFromJSON(json) {
    return CollectDocumentsFromJSONTyped(json, false);
}
exports.CollectDocumentsFromJSON = CollectDocumentsFromJSON;
function CollectDocumentsFromJSONTyped(json, ignoreDiscriminator) {
...
exports.CollectDocumentsFromJSONTyped = CollectDocumentsFromJSONTyped;
function CollectDocumentsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.CollectDocumentsToJSON = CollectDocumentsToJSON;

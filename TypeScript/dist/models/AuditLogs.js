...
var _1 = require("./");
function AuditLogsFromJSON(json) {
    return AuditLogsFromJSONTyped(json, false);
}
exports.AuditLogsFromJSON = AuditLogsFromJSON;
function AuditLogsFromJSONTyped(json, ignoreDiscriminator) {
...
exports.AuditLogsFromJSONTyped = AuditLogsFromJSONTyped;
function AuditLogsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.AuditLogsToJSON = AuditLogsToJSON;

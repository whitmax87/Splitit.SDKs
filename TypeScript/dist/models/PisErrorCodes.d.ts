 ...
 * @enum {string}
 */
export declare enum PisErrorCodes {
...
export declare function PisErrorCodesFromJSON(json: any): PisErrorCodes;
export declare function PisErrorCodesFromJSONTyped(json: any, ignoreDiscriminator: boolean): PisErrorCodes;
export declare function PisErrorCodesToJSON(value?: PisErrorCodes | null): any;

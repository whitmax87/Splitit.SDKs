 ...
 * @enum {string}
 */
export declare enum SystemEmailsTypes {
...
export declare function SystemEmailsTypesFromJSON(json: any): SystemEmailsTypes;
export declare function SystemEmailsTypesFromJSONTyped(json: any, ignoreDiscriminator: boolean): SystemEmailsTypes;
export declare function SystemEmailsTypesToJSON(value?: SystemEmailsTypes | null): any;

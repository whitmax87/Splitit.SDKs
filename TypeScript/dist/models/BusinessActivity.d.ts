 ...
 * @enum {string}
 */
export declare enum BusinessActivity {
...
export declare function BusinessActivityFromJSON(json: any): BusinessActivity;
export declare function BusinessActivityFromJSONTyped(json: any, ignoreDiscriminator: boolean): BusinessActivity;
export declare function BusinessActivityToJSON(value?: BusinessActivity | null): any;

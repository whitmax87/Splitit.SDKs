...
var _1 = require("./");
function PaymentGatewayTransactionLogsAllOfFromJSON(json) {
    return PaymentGatewayTransactionLogsAllOfFromJSONTyped(json, false);
}
exports.PaymentGatewayTransactionLogsAllOfFromJSON = PaymentGatewayTransactionLogsAllOfFromJSON;
function PaymentGatewayTransactionLogsAllOfFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'inverseReferencePaymentGatewayTransactionLog': !runtime_1.exists(json, 'InverseReferencePaymentGatewayTransactionLog') ? undefined : (json['InverseReferencePaymentGatewayTransactionLog'].map(_1.PaymentGatewayTransactionLogsFromJSON)),
...
exports.PaymentGatewayTransactionLogsAllOfFromJSONTyped = PaymentGatewayTransactionLogsAllOfFromJSONTyped;
function PaymentGatewayTransactionLogsAllOfToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'InverseReferencePaymentGatewayTransactionLog': value.inverseReferencePaymentGatewayTransactionLog === undefined ? undefined : (value.inverseReferencePaymentGatewayTransactionLog.map(_1.PaymentGatewayTransactionLogsToJSON)),
...
exports.PaymentGatewayTransactionLogsAllOfToJSON = PaymentGatewayTransactionLogsAllOfToJSON;

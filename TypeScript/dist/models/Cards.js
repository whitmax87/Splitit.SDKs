...
exports.CardsFromJSON = CardsFromJSON;
function CardsFromJSONTyped(json, ignoreDiscriminator) {
...
exports.CardsFromJSONTyped = CardsFromJSONTyped;
function CardsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.CardsToJSON = CardsToJSON;

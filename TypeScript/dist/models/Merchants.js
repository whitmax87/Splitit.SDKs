...
var _1 = require("./");
function MerchantsFromJSON(json) {
    return MerchantsFromJSONTyped(json, false);
}
exports.MerchantsFromJSON = MerchantsFromJSON;
function MerchantsFromJSONTyped(json, ignoreDiscriminator) {
...
exports.MerchantsFromJSONTyped = MerchantsFromJSONTyped;
function MerchantsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.MerchantsToJSON = MerchantsToJSON;

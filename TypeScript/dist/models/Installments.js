...
var _1 = require("./");
function InstallmentsFromJSON(json) {
    return InstallmentsFromJSONTyped(json, false);
}
exports.InstallmentsFromJSON = InstallmentsFromJSON;
function InstallmentsFromJSONTyped(json, ignoreDiscriminator) {
...
exports.InstallmentsFromJSONTyped = InstallmentsFromJSONTyped;
function InstallmentsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.InstallmentsToJSON = InstallmentsToJSON;

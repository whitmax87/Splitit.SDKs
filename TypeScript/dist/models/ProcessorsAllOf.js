...
var _1 = require("./");
function ProcessorsAllOfFromJSON(json) {
    return ProcessorsAllOfFromJSONTyped(json, false);
}
exports.ProcessorsAllOfFromJSON = ProcessorsAllOfFromJSON;
function ProcessorsAllOfFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ProcessorsAllOfFromJSONTyped = ProcessorsAllOfFromJSONTyped;
function ProcessorsAllOfToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ProcessorsAllOfToJSON = ProcessorsAllOfToJSON;

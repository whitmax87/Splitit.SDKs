...
var _1 = require("./");
function AgentsAllOfFromJSON(json) {
    return AgentsAllOfFromJSONTyped(json, false);
}
exports.AgentsAllOfFromJSON = AgentsAllOfFromJSON;
function AgentsAllOfFromJSONTyped(json, ignoreDiscriminator) {
...
exports.AgentsAllOfFromJSONTyped = AgentsAllOfFromJSONTyped;
function AgentsAllOfToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.AgentsAllOfToJSON = AgentsAllOfToJSON;

...
var _1 = require("./");
function InstallmentPlanTerminalDatasFromJSON(json) {
    return InstallmentPlanTerminalDatasFromJSONTyped(json, false);
}
exports.InstallmentPlanTerminalDatasFromJSON = InstallmentPlanTerminalDatasFromJSON;
function InstallmentPlanTerminalDatasFromJSONTyped(json, ignoreDiscriminator) {
...
exports.InstallmentPlanTerminalDatasFromJSONTyped = InstallmentPlanTerminalDatasFromJSONTyped;
function InstallmentPlanTerminalDatasToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.InstallmentPlanTerminalDatasToJSON = InstallmentPlanTerminalDatasToJSON;

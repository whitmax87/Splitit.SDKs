...
var _1 = require("./");
function InstallmentPlanSetupContextsAllOfFromJSON(json) {
    return InstallmentPlanSetupContextsAllOfFromJSONTyped(json, false);
}
exports.InstallmentPlanSetupContextsAllOfFromJSON = InstallmentPlanSetupContextsAllOfFromJSON;
function InstallmentPlanSetupContextsAllOfFromJSONTyped(json, ignoreDiscriminator) {
...
exports.InstallmentPlanSetupContextsAllOfFromJSONTyped = InstallmentPlanSetupContextsAllOfFromJSONTyped;
function InstallmentPlanSetupContextsAllOfToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.InstallmentPlanSetupContextsAllOfToJSON = InstallmentPlanSetupContextsAllOfToJSON;

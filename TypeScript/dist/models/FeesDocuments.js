...
var _1 = require("./");
function FeesDocumentsFromJSON(json) {
    return FeesDocumentsFromJSONTyped(json, false);
}
exports.FeesDocumentsFromJSON = FeesDocumentsFromJSON;
function FeesDocumentsFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'referenceFeesDocument': !runtime_1.exists(json, 'ReferenceFeesDocument') ? undefined : FeesDocumentsFromJSON(json['ReferenceFeesDocument']),
        ...
        'inverseReferenceFeesDocument': !runtime_1.exists(json, 'InverseReferenceFeesDocument') ? undefined : (json['InverseReferenceFeesDocument'].map(FeesDocumentsFromJSON)),
...
exports.FeesDocumentsFromJSONTyped = FeesDocumentsFromJSONTyped;
function FeesDocumentsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'InverseReferenceFeesDocument': value.inverseReferenceFeesDocument === undefined ? undefined : (value.inverseReferenceFeesDocument.map(FeesDocumentsToJSON)),
...
exports.FeesDocumentsToJSON = FeesDocumentsToJSON;

...
var _1 = require("./");
function PisSessionsAllOfFromJSON(json) {
    return PisSessionsAllOfFromJSONTyped(json, false);
}
exports.PisSessionsAllOfFromJSON = PisSessionsAllOfFromJSON;
function PisSessionsAllOfFromJSONTyped(json, ignoreDiscriminator) {
...
exports.PisSessionsAllOfFromJSONTyped = PisSessionsAllOfFromJSONTyped;
function PisSessionsAllOfToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.PisSessionsAllOfToJSON = PisSessionsAllOfToJSON;

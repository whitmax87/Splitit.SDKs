...
var _1 = require("./");
function TerminalsAllOfFromJSON(json) {
    return TerminalsAllOfFromJSONTyped(json, false);
}
exports.TerminalsAllOfFromJSON = TerminalsAllOfFromJSON;
function TerminalsAllOfFromJSONTyped(json, ignoreDiscriminator) {
...
exports.TerminalsAllOfFromJSONTyped = TerminalsAllOfFromJSONTyped;
function TerminalsAllOfToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.TerminalsAllOfToJSON = TerminalsAllOfToJSON;

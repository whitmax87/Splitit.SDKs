...
var _1 = require("./");
function UserWithActionItemFromJSON(json) {
    return UserWithActionItemFromJSONTyped(json, false);
}
exports.UserWithActionItemFromJSON = UserWithActionItemFromJSON;
function UserWithActionItemFromJSONTyped(json, ignoreDiscriminator) {
...
exports.UserWithActionItemFromJSONTyped = UserWithActionItemFromJSONTyped;
function UserWithActionItemToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.UserWithActionItemToJSON = UserWithActionItemToJSON;

...
function TermsAndConditions2FromJSON(json) {
    return TermsAndConditions2FromJSONTyped(json, false);
}
exports.TermsAndConditions2FromJSON = TermsAndConditions2FromJSON;
function TermsAndConditions2FromJSONTyped(json, ignoreDiscriminator) {
...
exports.TermsAndConditions2FromJSONTyped = TermsAndConditions2FromJSONTyped;
function TermsAndConditions2ToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.TermsAndConditions2ToJSON = TermsAndConditions2ToJSON;

...
var _1 = require("./");
function CardStateLogsFromJSON(json) {
    return CardStateLogsFromJSONTyped(json, false);
}
exports.CardStateLogsFromJSON = CardStateLogsFromJSON;
function CardStateLogsFromJSONTyped(json, ignoreDiscriminator) {
...
exports.CardStateLogsFromJSONTyped = CardStateLogsFromJSONTyped;
function CardStateLogsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.CardStateLogsToJSON = CardStateLogsToJSON;

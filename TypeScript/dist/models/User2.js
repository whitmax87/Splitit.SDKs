...
var _1 = require("./");
function User2FromJSON(json) {
    return User2FromJSONTyped(json, false);
}
exports.User2FromJSON = User2FromJSON;
function User2FromJSONTyped(json, ignoreDiscriminator) {
...
exports.User2FromJSONTyped = User2FromJSONTyped;
function User2ToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.User2ToJSON = User2ToJSON;

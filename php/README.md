...
This is Splitit Web API SDK source code for PHP 5.5+ applications.
...
Please follow the [installation procedure](#installation--usage) and then run the following (replace api key and username/password with your login information):
